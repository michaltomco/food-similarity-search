 ...
 * sum of Manhattan distances between macronutrient vectors limited to the same
 * category as this object.
 *
 * @author tomco
 */
public class FoodMetaObjectMapMacronutrientsWithCategory extends FoodMetaObjectMap {
     ...
     * @throws IOException
     */
    public FoodMetaObjectMapMacronutrientsWithCategory(BufferedReader stream) throws IOException {
        super(stream);
    }

    /**
     * Retrieves the distance from the object represented by the Manhattan
     * distance between macronutrients limited to the same category as this
     * object.
     *
    ...
    protected float getDistanceImpl(LocalAbstractObject obj, float[] metaDistances, float distThreshold) {
        ...
        float dist = 0;
        int i = 0;
        if (!object.getCategory().equals(getCategory())) {
            dist += 500;
        }
